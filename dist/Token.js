...
class ERCTokenManeger {
    constructor(walletOrProvider, address) {
        ...
        __classPrivateFieldSet(this, _ERCTokenManeger_wallet, walletOrProvider.Wallet || walletOrProvider, "f");
        __classPrivateFieldSet(this, _ERCTokenManeger_contract, new ethers_1.ethers.Contract(address, abi, __classPrivateFieldGet(this, _ERCTokenManeger_wallet, "f")), "f");
        this.defaultMethods = {
